    ...
    <form action="/user/saveOrUpdate" method="post">
        <ul class="forminfo">
            ...
            <li><label>账号</label>
                ...
                <input name="user.userName" type="text" class="dfinput" id="username" value="${user.userName}"/><i id="userNameI"></i></li>
            ...
            <c:if test="${user.userId eq null}">
                <li><label>密码</label><input name="user.password" type="text" class="dfinput" value="${user.password}"/><i>多个关键字用,隔开</i></li>

            </c:if>
            <li><label>姓名</label><input name="user.realName" type="text" class="dfinput" value="${user.realName}"/><i>多个关键字用,隔开</i></li>
            <li><label>邮箱</label><input name="user.email" type="text" class="dfinput" value="${user.email}"/><i>多个关键字用,隔开</i></li>
            <li><label>电话</label><input name="user.phone" type="text" class="dfinput" value="${user.phone}"/><i>多个关键字用,隔开</i></li>
            <li><label>角色</label>
